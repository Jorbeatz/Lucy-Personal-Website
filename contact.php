...
<html lang="en">
    <head>
        <meta charset="utf-8">
        <title>Contact | Dr. Lucy Hutner</title>
        ...
        <div class="main-container transition--fade">
            <section class="height-70 bg--dark imagebg page-title page-title--animate parallax" data-overlay="6">
                <div class="background-image-holder">
                    <img alt="image" src="http://via.placeholder.com/1600x1067" />
                </div>
                <div class="container pos-vertical-center">
                    <div class="row">
                        <div class="col-sm-10 col-sm-offset-1 text-center">
                            <h3>Dr. Lucy Hutner</h3>
                            <p class="lead">Want to schedule a meeting or say hello? I'd love to hear from you. Use the form below to get in contact with me. I promise to get in touch with you shortly.</p>
                        </div>
                    </div>
                    <!--end row-->
                </div>
            ...
            <section class="features features-10">
                ...
                <div class="feature bg--dark col-md-4 text-center">
                    ...
                    <p>
                        Email:
                        <a href="#">lucyhutnermd@gmail.com</a>
                    </p>
                </div>
            </section>
            <section>
                    ...
                    <div class="row">
                        <div class="col-sm-8 col-sm-offset-2">
                            <form class="form--square form-email" data-success="Thanks for your enquiry, we'll be in touch soon" data-error="Please fill all required fields">
                                <h4 class="text-center">Or reach her right here&hellip;</h4>
